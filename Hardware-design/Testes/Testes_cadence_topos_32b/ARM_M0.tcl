...
##############################################################################
# Top module name.
set DESIGN  CORTEXM0INTEGRATION
set DUT DUT
...
####################################################################
puts "Reading HDLs..."
read_hdl -v2001 ../../NRISC_ULA.v ../../Def_tam.v  ../../const.v ../../NRISC_UP.v ../../NRISC_InstructionDecoder.v ../../NRISC_PC_ctrl.v ../../NRISC_REGs.v ../../NRISC_IData.v ../../NRISC_DData.v ../Test_Arch/TopoArch.v ../Test_Arch/picorv32/picorv32.v ../Test_Arch/ARM_M0/cores/cortexm0_designstart_r2p0/logical/cortexm0_integration/verilog/cortexm0ds_logic.v ../Test_Arch/ARM_M0/cores/cortexm0_designstart_r2p0/logical/cortexm0_integration/verilog/CORTEXM0INTEGRATION.v
